...
api: 'POST /api/balancer/leverage/open/prepare'
---
...
const response = await fetch('https://trusser-issuer-backend.vercel.app/api/balancer/leverage/open/prepare', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://trusser-issuer-backend.vercel.app/api/balancer/leverage/open/prepare',
    headers={
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    },
