...
<Info>
  Read-only endpoints (balance queries, holder lookups, transfer compliance checks, status lookups) do not require a relayer and will work without one configured.
</Info>
<Tip>
