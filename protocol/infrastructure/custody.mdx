...
The [Relayer](/protocol/infrastructure/relayer) eliminates manual signing for backend operations. Instead of signing every transaction through your custody provider, configure a relayer with a vault-stored private key and execute operations through API calls.

The relayer complements traditional custody by handling routine automated tasks while you maintain custody control over high-value operations and admin functions.
