...
MiCA/eWpG-compliant KYC/AML registry shared across all token contracts in an instance. See [Customer Management](/learn/customers/customer-management) for conceptual documentation.
