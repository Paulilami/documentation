...
curl -H "x-api-key: your-api-key-here" \
  https://trusser-issuer-backend.vercel.app/api/stock-exchange/health
```
</CodeGroup>
<CodeGroup>
...
<CodeGroup>
```bash Check Status
curl https://trusser-issuer-backend.vercel.app/api/stock-exchange/status/LOCK-1642857600000-a1b2c3d4e5f6 \
  -H "x-api-key: your-api-key-here"
```
</CodeGroup>
<CodeGroup>
