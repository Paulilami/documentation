...
<CardGroup cols={2}>
    ...
    <Card title="Oracle Pricing" icon="chart-line" href="/new/learn/trading/amm/pricing">
        Price feed configuration and validation
    </Card>
    <Card title="Balancer Pools" icon="scale-balanced" href="/new/learn/trading/amm/balancer-pools">
        Core pool mechanics and liquidity provision
    </Card>
    <Card title="API Reference" icon="code" href="/api-reference/trading/controllers">
