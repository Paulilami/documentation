...
<CardGroup cols={2}>
    <Card title="Pool Controllers" icon="sliders" href="/new/learn/trading/amm/controllers">
        Administrative functions and pool configuration
    </Card>
    ...
    <Card title="Oracle Pricing" icon="chart-line" href="/new/learn/trading/amm/pricing">
        Price feed integration and deviation handling
    </Card>
    <Card title="API Reference" icon="code" href="/api-reference/trading/pools">
        Integration endpoints and parameters
    </Card>
</CardGroup>
